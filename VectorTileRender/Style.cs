    ...
    public class Style
    {
        ...
        private Color parseColor(object iColor)
        {
           ...
           // Debug.WriteLine("COLORSTRING: " + colorString);
            ...
            {
                var segments = colorString.Replace('%', '\0').Split(',', '(', ')');
                double.TryParse(segments[1], NumberStyles.Any, CultureInfo.InvariantCulture, out double h);
            ...
            {
                var segments = colorString.Replace('%', '\0').Split(',', '(', ')');
                double.TryParse(segments[1], NumberStyles.Any, CultureInfo.InvariantCulture, out double r);
                double.TryParse(segments[2], NumberStyles.Any, CultureInfo.InvariantCulture, out double g);
                double.TryParse(segments[3], NumberStyles.Any, CultureInfo.InvariantCulture, out double b);
               double.TryParse(segments[4], NumberStyles.Any, CultureInfo.InvariantCulture, out double a);

                return Color.FromArgb((byte)(a*255), (byte)r, (byte)g, (byte)b);
            }
