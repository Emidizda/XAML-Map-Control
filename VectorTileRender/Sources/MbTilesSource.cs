                    ...
                    while (reader.Read())
                    {
                        ...
                        switch (name.ToLower())
                        {
                            ...
                            case "center":
                                ...
                                double.TryParse(vals[0], NumberStyles.Any, CultureInfo.InvariantCulture, out double x);
                                double.TryParse(vals[1], NumberStyles.Any, CultureInfo.InvariantCulture, out double y);
                                this.Center = new GlobalMercator.CoordinatePair() { X = x, Y = y };
                                break;
                            case "minzoom":
